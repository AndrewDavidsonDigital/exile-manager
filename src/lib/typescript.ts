...
/**
 * Helper to take 2 types and return a intersection of first `T` and exclusions for 
 * all unique key of `X`
...
/**
 * Helper to take a collection of `n` type definitions and return a complete 
...
/**
 * Helper to take take a collection of types and return a new type that is representative of 
...
const _overflowedAsset : MediaAsset_Union = {
    ...
    extension: 'jpg',
    documentUrl: 'THIS SHOULD NOT BE VALID'
}
